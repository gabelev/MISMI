...
from asins import business_search_asins, business_tracking, amish_asin, all_search_asins
...
def all_search_runner():
    print("----MSG: Running All Search")
    all_search_result = run_spider_run(Search_all, all_search_asins)
    make_pickle(all_search_result, "all_search")
    reformat_data_add_column(all_search_result, 'all_search', 'search', business_tracking, collection_all_search)
